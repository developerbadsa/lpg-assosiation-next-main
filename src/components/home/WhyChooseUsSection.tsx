      ...
      <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_1_861)">
          ...
          <path
            ...
            fill="white"
          />
          <path d="M31.5468 9.1229C28.0285 7.51218 26.8134 2.92617 29.1056 0.00878906C32.4361 1.25806 33.9869 5.97283 31.5468 9.1229Z" fill="white" />
          <path d="M21.5969 9.10894C19.1987 5.84511 20.7603 1.30926 24.0525 0C26.3691 2.79639 25.0205 7.85036 21.5969 9.10894Z" fill="white" />
        </g>
        <defs>
...
const CONTENT: Record<ContentId, { badge: string; heading: string; body: string }> = {
  who: {
    badge: '?',
    heading: 'WHO ARE WE?',
    ...
    <section className="relative w-full my-12 md:py-16">
      ...
      <div className="lpg-container relative">
        ...
        <div className="mt-10 flex flex-col gap-6 lg:min-h-[570px] lg:flex-row lg:gap-6">
          <div className="relative w-full overflow-hidden rounded-[15px] shadow-[0_22px_40px_rgba(0,0,0,0.22)] h-[420px] sm:h-[520px] lg:h-auto lg:w-[700px]">
            <Image src={stationIllustration} alt="Modern LPG station illustration" fill priority className="object-cover" />

            <div className="absolute inset-x-0 bottom-0 w-full bg-[#228759da] px-4 sm:px-6 pb-6 pt-5">
              <div className="pointer-events-none absolute inset-0 z-[0]">
                <Image fill src={maskgridbg} alt="background" className="object-cover" />
              </div>
              ...
              return (
                <div
                  ...
                  className={[
                    ...
                    'h-[360px] w-[110px] sm:h-[370px] sm:w-[160px] md:h-[380px]  md:w-[145px] lg:h-full',
                    isActive ? 'ring-2 ring-[#46FF5B66] lg:ring-0' : '',
                  ].join(' ')}
                >
                  <div className="pointer-events-none absolute inset-0 z-[0] opacity-60">
                    <Image fill src={pill.img} alt={pill.label} className="object-cover" />
                  </div>

                  <div className="pointer-events-none absolute inset-0 z-[1] opacity-90">
                    <Image fill src={minigridbg} alt={pill.label} className="object-cover" />
                  </div>
